...
#define GTN__GT_1FCTF "One Lolly Capture"
...
enum { ICON_ARROW = 1, ICON_BALLOON = 2, ICON_TEAMMATE = 4, ICON_HEALTHSTATION = 8, ICON_SPRAYROOM = 16, ICON_FREEZETAG = 32, ICON_KILLERDUCK = 64 };

#define ICON_ALL (ICON_ARROW | ICON_BALLOON | ICON_TEAMMATE | ICON_HEALTHSTATION | ICON_SPRAYROOM | ICON_FREEZETAG | ICON_KILLERDUCK)
